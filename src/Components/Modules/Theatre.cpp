...
namespace Components
{
	...
	Theatre::Theatre()
	{
		Dvar::Register<bool>("cl_autoRecord", false, Game::dvar_flag::DVAR_FLAG_SAVED, "Automatically record games.");
		Dvar::Register<int>("cl_demosKeep", 0, 1, 999, Game::dvar_flag::DVAR_FLAG_SAVED, "How many demos to keep with autorecord.");
